...
public class GoodManListActivity extends ChildActivity implements UserAdapter.OnItemClickCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_good_man_list);
        initToolbar();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_good_man_list, menu);
        return true;
    }
